...
export const FAQSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-12 sm:py-20 lg:py-24 bg-[#0B0D10] border-b border-slate-800/80 relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="rounded-2xl border border-slate-800 bg-[#12161E] overflow-hidden transition-all duration-200"
              >
                <button
                  type="button"
                ...
                >
                  ...
                  <div className={`w-8 h-8 rounded-full bg-slate-800/80 flex items-center justify-center shrink-0 transition-transform duration-200 ${isOpen ? 'rotate-180 bg-amber-400/20 text-amber-300' : 'text-slate-400'}`}>
        ...
        <div className="mt-12 text-center p-6 rounded-2xl bg-[#141822] border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 text-xs font-bold text-slate-950 bg-amber-400 hover:bg-amber-300 rounded-xl transition-all shrink-0"
          >
