...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#07090E] border-t border-slate-800 text-slate-400 text-xs relative">
            ...
            <ul className="space-y-2.5">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-slate-400 hover:text-[#38BDF8] transition-colors inline-block"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-slate-300 hover:text-[#38BDF8] transition-colors font-medium"
              >
              ...
              <div className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-3.5 py-2 rounded-lg bg-[#0072CE]/15 hover:bg-[#0072CE]/30 text-[#38BDF8] border border-[#0072CE]/40 text-xs font-bold transition-all text-center w-full"
                >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-400 text-xs">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              type="button"
              onClick={scrollToTop}
              className="flex items-center gap-1 text-slate-300 hover:text-[#38BDF8] transition-colors p-1 cursor-pointer"
