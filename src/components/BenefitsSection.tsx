...
export const BenefitsSection: React.FC = () => {
  ...
  return (
    <section id="beneficios" className="py-12 sm:py-20 lg:py-24 bg-[#0A0E17] border-b border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 sm:mb-12 p-4 sm:p-5 rounded-2xl bg-[#0F1420] border border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs sm:text-sm font-semibold text-slate-300">
          <span className="text-sky-400">A jornada do aluno BS Trainer:</span>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-sky-400">→</span>
            <span className="bg-blue-600/25 text-sky-300 px-2.5 py-1 rounded-lg border border-sky-500/40 text-xs font-bold">Qualidade de Vida</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {benefits.map((benefit, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-5 sm:p-7 rounded-2xl bg-[#0E131E] border border-slate-800 hover:border-sky-500/30 transition-all flex flex-col justify-start group"
              >
                <div className="w-12 h-12 rounded-xl bg-sky-500/10 border border-sky-500/20 flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
