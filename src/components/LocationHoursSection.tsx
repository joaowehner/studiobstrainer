...
export const LocationHoursSection: React.FC = () => {
  return (
    <section id="localizacao" className="py-12 sm:py-20 lg:py-24 bg-[#0A0E17] border-b border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            ...
            {/* Address Card */}
            <div className="p-6 sm:p-7 rounded-2xl bg-[#0F1420] border border-slate-800">
              ...
              <div className="mt-5 pt-5 border-t border-slate-800 flex flex-wrap items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-xs font-bold text-white bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-500 hover:to-sky-400 rounded-lg shadow-md shadow-blue-500/20 transition-all"
                >
            ...
            <div className="p-6 sm:p-7 rounded-2xl bg-[#0F1420] border border-slate-800">
              ...
              <div className="space-y-2.5 text-xs sm:text-sm pl-1">
                <div className="flex items-center justify-between py-1.5 border-b border-slate-800/80">
                  ...
                  <span className="text-sky-400 font-bold">{businessData.hours.weekdays}</span>
                </div>
                <div className="flex items-center justify-between py-1.5 border-b border-slate-800/80">
            ...
            {/* Direct Contact Card */}
            <div className="p-5 rounded-2xl bg-gradient-to-r from-slate-900 to-[#101522] border border-slate-800 flex items-center justify-between">
          ...
          <div className="lg:col-span-7 flex flex-col">
            <div className="rounded-2xl border border-slate-800 overflow-hidden bg-[#0F1420] flex-1 min-h-[380px] sm:min-h-[460px] relative shadow-2xl flex flex-col">
              
              {/* Map Header Toolbar */}
              <div className="bg-[#090C12] px-4 py-3 border-b border-slate-800 flex items-center justify-between gap-2 text-xs">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sky-400 hover:text-sky-300 font-bold flex items-center gap-1 shrink-0"
                >
              ...
              {/* Map Footer Bar */}
              <div className="bg-[#090C12] px-4 py-2.5 border-t border-slate-800 text-[11px] text-slate-400 flex items-center justify-between">
